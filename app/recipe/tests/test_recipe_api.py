...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_filter_by_ingredients(self):
        ...
        r1 = create_recipe(user=self.user, title="Pasta Primavera")
        r2 = create_recipe(user=self.user, title='Chicken Tikka Masala')
        ingredient1 = Ingredient.objects.create(
            user=self.user,
            name="Pasta"
        )
        ...
        r3 = create_recipe(user=self.user, title='Vegetable Stir Fry')
